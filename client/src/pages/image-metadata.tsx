  ...
  const handleBatchProcess = async () => {
    ...
    try {
      ...
      for (const imageId of selectedImages) {
        ...
        if (image) {
          console.log(
            `  Image found - isCrawled: ${image.isCrawled}, URL: ${image.url}`
          );
          ...
          if (image.isCrawled || imageId.startsWith("crawled")) {
            ...
            if (url) {
              ...
              console.log(
                `  ✅ Added URL mapping: ${imageId} -> ${url.substring(
                  0,
                  50
                )}...`
              );
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    ...
                    {processOptions.action === "update" &&
                      "Update existing metadata fields"}
                    {processOptions.action === "scramble" &&
                      "Obfuscate image content for privacy"}
                  </p>
                </div>
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-blue-700">
                                These fields will be embedded in the image
                                file's EXIF data. This information can be viewed
                                in image editing software and helps establish
                                ownership and origin of the images.
                              </p>
                            </div>
                          </div>
                        </div>
