...
const seoIssues = [
  {
    ...
    description:
      "Several pages are missing meta descriptions, which are important for search engine results.",
  ...
  },
  {
    ...
    description:
      "Page load times are above recommended thresholds, affecting user experience and rankings.",
  ...
  },
  {
    ...
    description:
      "All pages now have proper structured data markup for better search visibility.",
        ...
        <div className="space-y-4">
          {seoIssues.map((issue) => {
            ...
            return (
              <div
                key={issue.id}
                className={`flex items-start space-x-4 p-4 rounded-lg ${styles.container}`}
              >
                <div
                  className={`w-6 h-6 ${styles.icon} rounded-full flex items-center justify-center flex-shrink-0`}
                >
                  {icon}
                </div>
                <div className="flex-1">
                  ...
                  {issue.type === "success" && (
                    <div className="flex items-center mt-2">
                      <span
                        className={`text-xs ${styles.title} flex items-center`}
                      >
