...
const SMTP_USER = "92782alicia@gmail.com";        // your@gmail.com
const SMTP_PASS = "bkyfjvstfxokxoix";         // 16-char Gmail App Password
const FROM_EMAIL = "92782alicia@gmail.com"; // should equal SMTP_USER or a verified Gmail alias
