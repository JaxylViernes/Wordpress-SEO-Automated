...
//         from: 'AI Content Manager <onboarding@resend.dev>', // Free domain they provide
//         to: email,
...
//             <div style="background: #f0f0f0; padding: 20px; text-align: center; font-size: 32px; letter-spacing: 5px;">
//               ${code}
//             </div>
